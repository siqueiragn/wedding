            ...
            <div class="container timeline position-relative p-0">
                <div class="row">
                    <div class="col-md-6 text-center text-md-right">
                        <img class="img-fluid mr-md-3" src="img/hist-1.png" alt="" style="height: unset !important";>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-center text-md-left">
                        <img class="img-fluid ml-md-3" src="img/hist-2.png" alt="" style="height: unset !important">
                    </div>
                    <div class="col-md-6 text-center text-md-right">
                ...
                <div class="row">
                    <div class="col-md-6 text-center text-md-right">
                        <img class="img-fluid mr-md-3" src="img/hist-3.jpg" alt="" style="height: unset !important">
                    </div>
                    <div class="col-md-6 text-center text-md-left">
                        <div class="h-100 d-flex flex-column justify-content-center bg-secondary p-4 ml-md-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-center text-md-left">
                        <img class="img-fluid ml-md-3" src="img/hist-4.jpg" alt="" style="height: unset !important">
                    </div>
                    <div class="col-md-6 text-center text-md-right">
                        <div class="h-100 d-flex flex-column justify-content-center bg-secondary p-4 mr-md-3">
                ...
                <div class="row">
                    <div class="col-md-6 text-center text-md-right">
                        <img class="img-fluid mr-md-3" src="img/hist-5.jpg" alt="" style="height: unset !important">
                    </div>
                    <div class="col-md-6 text-center text-md-left">
                        <div class="h-100 d-flex flex-column justify-content-center bg-secondary p-4 ml-md-3">
                            <h4 class="mb-2">Pedido de Namoro</h4>
                            <p class="text-uppercase mb-2">25/08/2023</p>
                            <p class="m-0">Após se reencontrarem (novamente em uma viagem de trabalho), o destino colocou os dois juntos novamente e dessa vez prontos para viver o relacionamento.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6 text-center text-md-left">
                        <img class="img-fluid ml-md-3" src="img/hist-6.jpg" alt="" style="height: unset !important">
                    </div>
                    <div class="col-md-6 text-center text-md-right">
                        <div class="h-100 d-flex flex-column justify-content-center bg-secondary p-4 mr-md-3">
