...
<body data-spy="scroll" data-target=".navbar" data-offset="51">
    ...
    <nav class="navbar fixed-top shadow-sm navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
            <div class="navbar-nav ml-auto py-0">
                ...
                <a href="#story" class="nav-item nav-link">História</a>
                <a href="#event" class="nav-item nav-link">Elenco</a>
            </div>
    ...
    <div class="container-fluid py-5" id="story">
        <div class="container pt-5 pb-3">
            <div class="section-title position-relative text-center">
                <h6 class="text-uppercase text-primary mb-3" style="letter-spacing: 3px;">História</h6>
                <h1 class="font-secondary display-4">Nossa História</h1>
            ...
            <div class="container timeline position-relative p-0">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-center text-md-left">
                        <img class="img-fluid ml-md-3" src="img/hist-2.png" alt="">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 text-center text-md-right">
                        <img class="img-fluid mr-md-3" src="img/hist-3.jpg" alt="">
                    </div>
                    <div class="col-md-6 text-center text-md-left">
                        <div class="h-100 d-flex flex-column justify-content-center bg-secondary p-4 ml-md-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-center text-md-left">
                        <img class="img-fluid ml-md-3" src="img/hist-4.jpg" alt="">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 text-center text-md-right">
                        <img class="img-fluid mr-md-3" src="img/hist-5.jpg" alt="">
                    </div>
                    <div class="col-md-6 text-center text-md-left">
                        <div class="h-100 d-flex flex-column justify-content-center bg-secondary p-4 ml-md-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-center text-md-left">
                        <img class="img-fluid ml-md-3" src="img/hist-6.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid py-5" id="event">
        <div class="container py-5">
            <div class="section-title position-relative text-center">
                <h6 class="text-uppercase text-primary mb-3" style="letter-spacing: 3px;">Time Completo</h6>
                <h1 class="font-secondary display-4">Noiva & Noivo</h1>
                <i class="far fa-heart text-dark"></i>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 text-center">
                    <h5 class="font-weight-normal text-muted mb-3 pb-3">Colegas de trabalho desde 2018, cresceram e evoluíram juntos, exploraram e viveram muitas experiências lado a lado e, após alguns anos perdidos um do outro, <span class="riscado">finalmente</span> vão se casar e oficializar essa união perante Deus e o mundo.</h5>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 border-right border-primary">
                    <div class="text-center text-md-right mr-md-3 mb-4 mb-md-0">
                        <img class="img-fluid mb-4" src="img/nati.jpg" style="object-fit: cover;">
                        <h4 class="mb-3">Natália Jahnke</h4>
                        <!-- <p class="mb-2">XX</p> -->
                        <!-- <p class="mb-0">XX</p> -->
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="text-center text-md-left ml-md-3">
                        <img class="img-fluid mb-4" src="img/gabriel.png" alt="">
                        <h4 class="mb-3">Gabriel Siqueira</h4>
                        <!-- <p class="mb-2">XX</p> -->
                        <!-- <p class="mb-0">XX</p> -->
                    </div>
                </div>
    ...
    <div class="container-fluid py-5" id="family">
        <div class="container pt-5 pb-3">
            <?php require 'lista_elenco.php'; ?>
        </div>
    </div>
    <!-- Friends & Family End -->

    <!-- Friends & Family Start -->
    <div class="container-fluid py-5" id="gift-list">
        <div class="container pt-5 pb-3">
            <?php require 'lista_presentes.php'; ?>
        </div>
    </div>
    <!-- Friends & Family End -->
    ...
    <div class="container-fluid py-5" id="rsvp">
        <div class="container py-5">
            <?php require 'envie_mensagem.php'; ?>
        </div>
    </div>
    <!-- RSVP End -->
