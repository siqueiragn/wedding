...
<body data-spy="scroll" data-target=".navbar" data-offset="51">
    ...
    <nav class="navbar fixed-top navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5" style="display: flex !important;">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
            ...
            <div class="navbar-nav mr-auto py-0">
                ...
                <a href="#roteiro" class="nav-item nav-link">Roteiro</a>
    ...
    <div class="container-fluid py-5" id="roteiro">
        <div class="container py-5">
            <?php require 'roteiro.php'; ?>
        </div>
    </div>
...
<!-- 
    ...
    <!-- Back to Top -->
    <a href="#" class="btn btn-lg btn-outline-primary btn-lg-square back-to-top" style="background-color: #e44702; color: white; width: 100%; font-size: 0.85em;">CONFIRME A PRESENÇA CLICANDO AQUI &nbsp;<img style="height: 30px;" src="img/whatsapp.png"> </a>
