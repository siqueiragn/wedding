<div class="section-title position-relative text-center">
                <h6 class="text-uppercase text-primary mb-3" style="letter-spacing: 3px;">Roteiro</h6>
                <h1 class="font-secondary display-4">Roteiro do dia</h1>
            ...
            <div class="row portfolio-container">
                ...
                <div class="col-lg-6 col-md-6 offset-lg-3 offset-xs-3 portfolio-item">
                    <div class="position-relative mb-2">
                        <img class="img-fluid w-100" src="img/roteiro/zanfir.png" alt="">
                ...
                <div class="col-lg-6 col-md-6 offset-lg-3 offset-xs-3 portfolio-item">
                    <div class="position-relative mb-2">
                        <img class="img-fluid w-100" src="img/roteiro/openbar.jpg" alt="">
                        <div class="bg-secondary text-center p-4">
